...
import { setShowAddSuperBranchModal } from "../../../redux/features/global/globalSlice";
...
const AddSuperBranch = () => {
  ...
  const closeModal = () => {
    dispatch(setShowAddSuperBranchModal(false));
  };
        ...
        <FormProvider {...methods}>
          <GoForm onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="modal-body">
              ...
              <GoInput
                name="notes"
                label="Super Branch Name"
                placeholder="Enter Super Branch Name"
                required
              />
            </div>
            {/* Modal Footer */}
